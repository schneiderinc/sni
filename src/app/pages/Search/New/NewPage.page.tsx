import { IonContent, IonLabel, IonSelect, IonSelectOption, IonRow, IonCol, IonButton, IonDatetime, IonInput, IonItem, IonRange, IonToggle, IonList, IonImg, IonSearchbar, IonIcon } from '@ionic/react';
        ...
        <div className="contianer">
          ...
          <form className="search-form"  >
            ...
            <IonItem class="ion-item">
              ...
              <IonItem class="ion-item">
                <IonLabel position="floating">Pickup Date</IonLabel>
